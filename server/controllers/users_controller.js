...
const addUsers = async (req, res, next) => {
    let users;
    const { schoolId, userType, userFirstName, userMiddleName, userLastName, userCourse, userYear, userDepartment, userImage, bookShelfId, userEmail, userStatus, userRole, userSchool } = req.body
...
const updateUsers = async(req,res,next)=>{
    ...
    console.log(_id)
    let users;
    const { schoolId, userType, userFirstName, userMiddleName, userLastName, userCourse, userYear, userDepartment, userImage, bookShelfId, userEmail, userPassword, userStatus, userRole, userSchool } = req.body
    try{
        users = await userModel.findByIdAndUpdate(_id,{
            schoolId,
            userType,
            userFirstName,
            userMiddleName,
